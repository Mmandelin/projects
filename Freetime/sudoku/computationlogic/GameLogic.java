...
public class GameLogic {
    ...
    public static SudokuGame getNewGame() {
        ...
        //vaikeustason optionpanel. antaa popup ikkunan, jossa on kuva ja vetovalikko vaihtoehdoille
        //easy medium ja hard. käyttäjä voi valita vaikeustason ja painaa ok, sen jälkeen getnewgame
        //funktio lataa sen vaikeustason pelin
        ...
        ImageIcon icon = new ImageIcon("E:\\appi projektit\\java\\Sudoku\\difficulty.jpg");
        String vaikeus = (String) JOptionPane.showInputDialog(
                frame,
                "Choose difficulty",
                "Difficulty",
        ...
        if(vaikeus.equals("Easy")){
            return new SudokuGame(
                    GameState.NEW,
                    GameGeneratorEasy.getNewGameGrid()
            );
        }

        else if(vaikeus.equals("Medium")){
            return new SudokuGame(
                    GameState.NEW,
                    GameGeneratorMedium.getNewGameGrid()
            );
        }
            ...
            return new SudokuGame(
                    GameState.NEW,
                    GameGeneratorHard.getNewGameGrid()
            );
        }
    }
