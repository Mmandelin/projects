...
class GameGeneratorHard {
    public static int[][] getNewGameGrid() {
        return unsolveGameHard(getSolvedGameHard());
    }
    ...
    private static int[][] getSolvedGameHard() {
    ...
    private static int[][] unsolveGameHard(int[][] solvedGame) {
        Random random = new Random(System.currentTimeMillis());
