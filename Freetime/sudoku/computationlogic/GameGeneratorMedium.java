...
class GameGeneratorMedium {
    public static int[][] getNewGameGrid() {
        return unsolveGameMedium(getSolvedGameMedium());
    }
    ...
    private static int[][] getSolvedGameMedium() {
    ...
    private static int[][] unsolveGameMedium(int[][] solvedGame) {
        Random random = new Random(System.currentTimeMillis());
